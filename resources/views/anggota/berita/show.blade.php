<x-app>
    <div class="card">
        <div class="card-header">
            ...
            <x-button.back url="anggota/berita-anggota" id="{{ $berita->id }}" />
            <a href="{{url('anggota/berita-anggota', $berita->id)}}/edit" class="btn btn-warning float-right">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-lg-6 order-1 order-md-2">
                    ...
                    <p class="text-black">{{ $berita->penulis_berita }}</p>
                    <dt>Deskripsi</dt>
