            ...
            <form method="POST" action="{{ url('weberita') }}" id="newsForm" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <div class="col-sm-12 mt-4">
                     <textarea name="deskripsi" class="form-control summernote"> Ada Berita Terbaru Apa ?</textarea>
                    </div>
                </div>
               
                <div class="form-group row mb-0 mt-4">
                    <div class="col-sm-12">
                        <button  class="btn btn-primary float-end" data-toggle="modal" data-target="#confirmationModal"><span class="fa fa-save"></span> Simpan</button>
                    </div>
                </div>
            </form>
           </div>
